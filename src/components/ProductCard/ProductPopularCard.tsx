...
const ProductPopularCard = ({ product }:any) => {
            ...
            <StyledWrapper>
                <div className="card">
                    ...
                    <div className="card-info">
                        ...
                        <p className="text-body">{product.desctiption}</p>
                    </div>
...
const StyledWrapper = styled.div`
    ...
    .card-img:hover {
        ...
        box-shadow: rgb(21 93 252 / 0.3) 0px 13px 47px -5px, rgb(59 21 252 / 0.3) 0px 8px 16px -8px;
    }
